...
void AMain::BeginPlay()
{
	...
	// We will use this instance of our PlayerController to access/change our HUD visibility/functionality in...
...
{
	// The argument passed in above must be one of the const options present...
	// ...in the Enum. That then determines the value of MovementStatus, the...
	// ...instance of our enum.
	MovementStatus = Status;

	// If the enum instance named MovementStatus is equal to EMS_Sprinting...
	// ...the character speed is accessed and increased/set to SprintingSpeed.
...
{
	// If EquippedWeapon variable is already filled with a weapon, it will be destroyed so a different on can be equipped.
	if (EquippedWeapon)
	{
